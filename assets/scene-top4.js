...
var TD_SCENES4 = {
  ...
  parkgap: function (p) {
    ...
    return tdParkBase(p) +
      ...
      /* คนขี่วิ่งทางเดียวกับเรา จึงต้องอยู่ครึ่งบนเหมือนกัน ไม่ใช่ครึ่งล่างซึ่งเป็นเลนสวน
         วางชิดเส้นแบ่งกลาง เพราะรถที่จอดห่างขอบทางกินช่องซ้ายไปจนเบียดคนขี่ออกมาเท่านี้
         ซึ่งคือสิ่งที่คำอธิบายของข้อนี้พูดถึงพอดี */
      tdPath('tdpM', 'M-30 ' + (cy - 5) + ' L430 ' + (cy - 5), TD_RED, 460, 0) +
