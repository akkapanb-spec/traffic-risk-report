...
| `sql/officer_admin2.sql` | แก้ไข/ลบข้อมูลเจ้าหน้าที่ + ตั้ง-ถอด admin จากหน้าเว็บ |
| `sql/accident_admin.sql` | แก้ไข/ลบเคสอุบัติเหตุ (ผู้บาดเจ็บปรับตาม) + แก้เนื้อหาการแจ้งจุดเสี่ยง |
| `sql/blackspot_1_tables.sql` | ระบบวิเคราะห์จุดเสี่ยง (1/4): ตาราง `bs_*` 6 ตัว + index + ค่าเกณฑ์ตั้งต้น |
| `sql/blackspot_2_rls.sql` | ระบบวิเคราะห์จุดเสี่ยง (2/4): RLS + policy — ประชาชนอ่านได้เฉพาะผลที่เผยแพร่แล้ว |
| `sql/blackspot_3_rpc.sql` | ระบบวิเคราะห์จุดเสี่ยง (3/4): RPC จัดการจุดกายภาพ/จุดเกิดเหตุ/โซน/ค่าเกณฑ์ |
| `sql/blackspot_4_publish.sql` | ระบบวิเคราะห์จุดเสี่ยง (4/4): RPC บันทึกและเผยแพร่ผลวิเคราะห์ |
